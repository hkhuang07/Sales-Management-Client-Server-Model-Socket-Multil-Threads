    ...
    public partial class frmLogin : Form
    {
        ...
        private async void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (LoggedInUser != null && LoggedInUser.Success)
                {
                ...
                {
                    MessageBox.Show(LoggedInUser?.Message ?? "Login failed. Received empty user data.", "Login Failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtPassword.Clear();
                    txtPassword.Focus();
                }
            }
